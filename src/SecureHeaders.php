...
use codicastudio\SecureHeaders\Builders\ContentSecurityPolicyBuilder;
use codicastudio\SecureHeaders\Builders\ExceptCTBuilder;
use codicastudio\SecureHeaders\Builders\FeaturePolicyBuilder;
